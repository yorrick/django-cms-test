...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_polls_pollplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Poll'])),
        ))
        db.send_create_signal(u'djangocms_polls', ['PollPlugin'])


    def backwards(self, orm):
        # Deleting model 'PollPlugin'
        db.delete_table(u'djangocms_polls_pollplugin')
